...
### Lista de exercícios opcional 02

Este repositório contém a resolução de 50 exercicos em JavaScript do curso FullStack da +praTi.

## Estrutura 🗂
Todos os exercícios estão contidos dentro da pasta ``ListaTarefaOpcional02`` <br>

O Exercicio final 50 está contido dentro de ``ListaTarefaOpcional02/50`` uma vez que é um mini projeto. <br>
